...
*/
SenseMeThermistorClass::SenseMeThermistorClass()
{
}
...
* Nothing to be done.
*/
void SenseMeThermistorClass::begin() 
{
}
...
* Nothing to be done.
*/
void SenseMeThermistorClass::end() 
{
}
...
*/
float SenseMeThermistorClass::temperature(temperatureUnits units)
{
...
* 
*/
float SenseMeThermistorClass::temperature(temperatureUnits units, float B, float T0, float R0, float R_Balance)
{
	float R, T;
...
*
*/
uint16_t SenseMeThermistorClass::temperatureRaw()
{
 ...
 */ 
SenseMeThermistorClass SenseMeThermistor = SenseMeThermistorClass();
